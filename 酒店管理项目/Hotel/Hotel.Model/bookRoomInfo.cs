...
namespace Hotel.Model
{
    public class bookRoomInfo
    {
        ...
        /// 实际房价
        /// </summary>
        public float r_RelPrice { get; set; }
        ...
        public bookRoomInfo(int number, int rid, string cname, bool sexs, string zjtyoe, string zjnumber, string address, DateTime intime, int aboutday, float yajin, DateTime lavetime, string nation, string phone, float relprice, string Intype, string infriend, int peoplecount, string Inhour, string leavehour)
        {
