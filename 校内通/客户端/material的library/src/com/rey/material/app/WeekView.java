...
public class WeekView extends FrameLayout{
	...
	private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.rey.material.R.styleable.WeekView, defStyleAttr, defStyleRes);

        mVerticalPadding = a.getDimensionPixelOffset(com.rey.material.R.styleable.WeekView_wv_verticalPadding, ThemeUtil.dpToPx(context, 8));
        mHorizontalPadding = a.getDimensionPixelOffset(com.rey.material.R.styleable.WeekView_wv_horizontalPadding, ThemeUtil.dpToPx(context, 8));
        int animDuration = a.getInteger(com.rey.material.R.styleable.WeekView_wv_animDuration, context.getResources().getInteger(android.R.integer.config_mediumAnimTime));
        mBackgroundColors = a.getColorStateList(com.rey.material.R.styleable.WeekView_wv_backgroundColor);
