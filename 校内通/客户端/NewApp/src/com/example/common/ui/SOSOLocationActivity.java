...
public class SOSOLocationActivity extends MapActivity implements
    ...
    protected void onDestroy() {
        ...
        if (RongCloudEvent.getInstance().getLastLocationCallback() != null)
        	RongCloudEvent.getInstance().getLastLocationCallback().onFailure("失败");
    ...
    public void onClick(View v) {
        ...
        if (mMsg != null) {
            RongCloudEvent.getInstance().getLastLocationCallback().onSuccess(mMsg);
            RongCloudEvent.getInstance().setLastLocationCallback(null);
            finish();
        } else {
        	RongCloudEvent.getInstance().getLastLocationCallback()
                    .onFailure("定位失败");
        }

    }
    
    public static final String KEY = "CW7BZ-KA2W3-2Z23K-3JSDG-DPROF-G4FE7";
    ...
    public boolean handleMessage(Message msg) {
        if (msg.what == RENDER_POI) {
            ...
            Uri uri = Uri
                    ...
                    .appendQueryParameter("key", KEY).appendQueryParameter("zoom", "16")
